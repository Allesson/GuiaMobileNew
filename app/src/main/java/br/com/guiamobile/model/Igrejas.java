...
/**
 * Created by Allesson on 23/05/2016.
 */
public class Igrejas {
    protected static final String IGREJA1=
            "INSERT INTO tbl_pontoIgrejas (titulo,descricao,texto, latitude, longitude, idTab)" +
                    "values ('Igreja da Soledade'," +
                    "'Rua da Soledade, s/n, Boa Vista.'," +
                    " 'Situada numa pequena praça que tem sua denominação, foi o terreno em que se acha edificada a igreja doada em 1714 pelo capitão de regimento de linha do Recife, Eusébio de Oliveira Monteiro e sua esposa Dona Maria da Fonseca, sendo assentada a primeira pedra em 28 de setembro de 1716 pelo governador do Bispado, o padre Antonio Manoel. Reconstruiu-se em 1845, depois em 1871 e ainda em 1897. Passou por grandes reparos. Por novas reformas passou ainda a capela de Nossa Senhora da Soledade, sendo feita por essa ocasião torre do lado direito e a pintura total da capela. Tomaram frente e direção dos mesmos trabalhos o Dr. Álvaro Ramos e o Sr. Eugênio Barreto.'," +
                    "-8.056360,"+"-34.889865,"+"1"+
                    ");";

    protected static final String IGREJA2=
            "INSERT INTO tbl_pontoIgrejas (titulo,descricao,texto, latitude, longitude, idTab)" +
                    "values ('Basílica da Penha'," +
                    " 'Praça Dom Vital, S/N - São José.'," +
                    " 'A Basílica da Penha é um templo religioso católico romano situado no município de Recife, Pernambuco. Pertence à Ordem dos Frades Menores Capuchinhos, na Arquidiocese de Olinda e Recife. De estilo coríntio, foi construído no século XVII e pertence ao bairro de São José.'," +
                    "-8.0682547,"+"-34.8781609,"+"1"+
                    ");";

    protected static final String IGREJA3=
            "INSERT INTO tbl_pontoIgrejas (titulo,descricao,texto, latitude, longitude, idTab)" +
                    "values ('Basílica e Convento de Nossa Senhora do Carmo'," +
                    "'Avenida Dantas Barreto s/n - Santo Antônio.'," +
                    " 'A Basílica e Convento de Nossa Senhora do Carmo é um conjunto arquitetônico católico pertencente à Ordem Carmelita. A igreja segue o estilo rococó. O corpo principal tem dois pavimentos, ambos com três aberturas de arco abatido e ornamentos em cantaria.\n"+
                    "\nNo piso superior, entre as janelas, encontram-se dois nichos com estátuas, interligados na parte superior a óculos obturados com grades, e também emoldurados. Acima, frontíspício triangular de vértices truncados e lados curvos, com brasão da Ordem, pesadas volutas floreadas, e culminando com um nicho com imagem de Nossa Senhora, pináculos e uma cruz.\n"+
                    "\nLateralmente a igreja possui duas torres, sendo que a da direita permanece inacabada, e a da esquerda, com cerca de 50 metros de altura, ergue-se em quatro pisos, com aberturas de forma e tamanho variáveis: a da base é uma porta com arco pleno, e acima abrem-se, sucessivamente, uma porta de arco abatido, com balaústre, um óculo simples, e uma janela sineira também em arco pleno. Coroando a torre, cúpula com diversas cornijas ornamentadas superpostas, óculos, pináculos e cruz.'," +
                    "-8.0667334,"+"-34.881813,"+"1"+
                    ");";

    protected static final String IGREJA4=
            "INSERT INTO tbl_pontoIgrejas (titulo,descricao,texto, latitude, longitude, idTab)" +
                    "values ('Igreja Matriz do Santíssimo Sacramento de Santo Antônio'," +
                    "'Praça da Independência, s/n - Santo Antônio.'," +
                    ...
                    "\nA decoração do interior se estendeu até o século XIX, com esplêndida obra de talha principalmente na capela-mor, além de painéis pintados de Sebastião da Silva Tavares. A pintura e a douração foram realizadas por Manuel de Jesus Pinto entre 1790 e 1805. A fachada é barroca, com rica ornamentação. O corpo central da igreja tem ao nível do solo três aberturas de entrada, em arco abatido, com ombros e lintel de arenito, encimado por florão em motivo de concha, sendo o vão central maior e emoldurado por um frontispício relativamente discreto. As portas são de madeira entalhada com almofadões volumosos, típicos do barroco.'," +
                    "-8.0643114,"+"-34.8790286,"+"1"+
                    ");";

    protected static final String IGREJA5=
            "INSERT INTO tbl_pontoIgrejas (titulo,descricao,texto, latitude, longitude, idTab)" +
                    "values ('Igreja Madre de Deus'," +
                    "'Rua Madre de Deus, s/n - Recife Antigo.'," +
                    " 'Igreja Madre de Deus é um templo religioso católico romano da cidade do Recife, Pernambuco. Situa-se na Rua Madre de Deus, no Bairro do Recife, ao lado do Paço Alfândega. A construção do templo só veio a ser concluída em 1720, apresentando em sua fachada esculturas em pedras dos arrecifes e uma estátua de São Felipe Néri em tamanho natural. A igreja abriga, além de uma obra em talha, algumas imagens que pertenceram à primitiva igreja do Corpo Santo, demolida em 1913, quando das obras de modernização do porto.'," +
                    "-8.0642707,"+"-34.8741655,"+"1"+
                    ");";

    protected static final String IGREJA6=
            "INSERT INTO tbl_pontoIgrejas (titulo,descricao,texto, latitude, longitude, idTab)" +
                    "values (' Igreja do Bom Jesus dos Martírios'," +
                    "'R. Manoel Benedito Soberinho, Boa Vista.'," +
                    ...
                    "-7.2621492,"+"-36.2415789,"+"1"+
                    ");";
    protected static final String IGREJA7=
            "INSERT INTO tbl_pontoIgrejas (titulo,descricao,texto, latitude, longitude, idTab)" +
                    "values ('Igreja de Santo Amaro das Salinas'," +
                    "'Praça Gen. Abreu e Lima, s/n, Santo Amaro.'," +
                    ...
                    "-8.0470371,"+"-34.8757741,"+"1"+
                    ");";

    protected static final String IGREJA8=
            "INSERT INTO tbl_pontoIgrejas (titulo,descricao,texto, latitude, longitude, idTab)" +
                    "values ('Igreja de Nossa Senhora do Terço'," +
                    "' Pátio do Terço, s/n, São José'," +
                    " 'A Igreja de Nossa Senhora do Terço é uma igreja católica da cidade do Recife, Pernambuco, Brasil. Situa-se no tradicional Pátio do Terço, no bairro de São José, entre a rua Direita e a rua das Águas Verdes.\n"+
                    ...
                    "-8.0691476,"+"-34.8805165,"+"1"+
                    ");";

    protected static final String IGREJA9=
            "INSERT INTO tbl_pontoIgrejas (titulo,descricao,texto, latitude, longitude, idTab)" +
                    "values ('Igreja de Nossa Senhora do Rosário dos Pretos'," +
                    "'R. Estreita do Rosário, s/n - Santo Antônio.'," +
                    " 'A Igreja de Nossa Senhora do Rosário dos Pretos localiza-se em Recife, estado de Pernambuco.\n"+
                    "\nO culto à santa foi introduzido na cultura dos escravos africanos no Brasil pelos jesuítas na catequese, para legitimar a religião católica, buscando homens e mulheres negros para a pratica religiosa. A igreja teve sua fundação entre os anos de 1662 a 1667, no período do reinado de D. Afonso VI de Portugal, venerado por essa instituição que conserva dele um retrato pintado a óleo na sacristia. No altar existem os santos negros como o rei Baltazar, São Elesbão, São Benedito, Santo Antonio de Catagerona e Santa Ifigênia. A rua na frente da igreja recebeu a denominação de Rua Estreita do Rosário.'," +
                    "-12.9711052,"+"-38.5080957,"+"1"+
                    ");";

    protected static final String IGREJA10=
            "INSERT INTO tbl_pontoIgrejas (titulo,descricao,texto, latitude, longitude, idTab)" +
                    "values ('Igreja de Nossa Senhora do Pilar'," +
                    "' Nossa Senhora do Pilar, s/n, bairro do Recife'," +
                    ...
                    "-8.056128,"+"-34.8723937,"+"1"+
                    ");";

    protected static final String IGREJA11=
            "INSERT INTO tbl_pontoIgrejas (titulo,descricao,texto, latitude, longitude, idTab)" +
                    "values ('Igreja Batista da Capunga'," +
                    "'R. João Fernandes Viêira, 769 - Parque Amorim.'," +
                    " 'Igreja Batista da Capunga é uma comunidade de fé cristã, composta hoje por dois mil membros, vinculada à Convenção Batista Brasileira (CBB) e a Convenção Batista de Pernambuco e se reúne no templo situado na Rua Fernandes Vieira, 769, no bairro da Boa Vista, no município do Recife, Estado de Pernambuco. Organizada a 19 de abril de 1923, por um grupo de treze cristãos batistas, oriundos das Igrejas Batistas de Olinda e do Zumby, no Recife, sob a liderança do missionário William Carey Taylor, elegendo como pastor o missionário James Leonel Downing (1923), sucedido no pastorado por Harvey Harold Muirhead (1924-1928), Robert Stanley Jones (1928-1930), José Munguba Sobrinho (1930-1967), Livio Calcanti Lindoso (1967-1970), Manfred Grellert (1970-1980), José Almeida Guimarães (1980-2006) e Ney Silva Ladeia (2006-2015). A igreja está situada no bairro da Boa Vista ao lado do Colégio Americano Batista. O seu templo em estilo clássico, com colunas ornamentais gregas, e o maior da denominação batista no Estado, sua nave e uma galeria permite perspectivas diferente das celebrações realizadas. O templo tem recebido assembléias dos batistas e congressos de instituições e grupos evangélicos reunidos em conferências bíblicas e teológicas. Conhecida por ser uma igreja tradicional, os cultos da Capunga são caracterizados pela sobriedade e pelo uso de instrumentos clássicos, como o órgão e o piano. Possui 1200 lugares.'," +
                    "-8.052473,"+"-34.8970104,"+"1"+
                    ");";

    protected static final String IGREJA12=
            "INSERT INTO tbl_pontoIgrejas (titulo,descricao,texto, latitude, longitude, idTab)" +
                    "values ('Convento e Igreja de Santo Antônio'," +
                    "'R. Imperador Pedro Segundo, 206, Santo Antônio'," +
                    " 'O Convento e Igreja de Santo Antônio do Recife, estado de Pernambuco, são edificações religiosas católicas pertencentes à Ordem Franciscana. Do complexo de edifícios, além do Convento e da Igreja, fazem parte a Capela Dourada e o Museu Franciscano de Arte Sacra.\n"+
                    ...
                    "-8.03820809,"+"-34.86243105,"+"1"+
                    ");";

    protected static final String IGREJA13=
            "INSERT INTO tbl_pontoIgrejas (titulo,descricao,texto, latitude, longitude, idTab)" +
                    "values ('Convento de São Félix'," +
                    "'R. José Rodrigues, 160 - Pina.'," +
                    " 'Igreja de Chelas Localizado na comunidade da Areinha no bairro do Pina, Recife, é conhecido por ter sido residencia de frei Damião e por abrigar, numa capela anexa, o seu túmulo, que recebe milhares de visitantes anualmente, inclusive de pessoas ilustres como o ex-presidente Fernando Collor de Mello. Em 06/08/1966, os frades brasileiros apresentaram ao ministro geral, Frei Clementino de Vlissingen, o pedido para construir uma nova casa em Recife-PE. E, aos 13 de outubro do mesmo ano, recebiam o rescrito da sagrada Congregação dos Religiosos, autorizando a ereção canônica da casa. Realizada a construção, a residência foi inaugurada com o nome de “Centro Antoniano de Boa Viagem”, pelo Custódio Geral, Frei Urbano de Sertânia, aos 19 de abril de 1970.\n"+
                    "\nConstruído com a finalidade de sediar a Custódia Geral de Pernambuco e criar condições mais humanas para a população sofrida do bairro do Pina, o Centro Antoniano sediava um posto médico, a distribuição de alimentos da Cáritas Diocesana e uma escola primária. Em convênio com o Estado, quase mil crianças estudavam no Centro. À noite, o MOBRAL (Movimento Brasileiro de Alfabetização) completava a utilização da área. E, assim, funcionou por quinze anos.\n"+
                    "\nEm 2001, foi construído um novo prédio para a residência dos frades. É a casa de Formação para pós-noviços de Filosofia e Teologia. Há duas capelas agregadas ao convento: uma dedicada a São Félix de Cantalice e a outra a Nossa Senhora das Graças. Nesta última, encontra-se o túmulo do famoso missionário, em processo de canonização, Frei Damião de Bozzano, para onde acorrem milhares de pessoas durante todo o ano. Todos os domingos, o convento torna-se local de romarias advindas dos vários Estados do Nordeste.'," +
                    "-8.0957202,"+"-34.8892414,"+"1"+
                    ");";

    protected static final String IGREJA14=
            "INSERT INTO tbl_pontoIgrejas (titulo,descricao,texto, latitude, longitude, idTab)" +
                    "values ('Capela Dourada'," +
                    "'R. Imperador Pedro Segundo, s/n - Santo Antônio.'," +
