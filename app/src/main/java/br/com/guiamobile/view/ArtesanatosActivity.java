 ...
 */
public class ArtesanatosActivity extends AppCompatActivity {

    private static final int BUSCAR = 1;
    private ListView lista;
    private PontoArtesanatosRepositorio pontoArtesanatosRepositorio;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.Artesanatos);
        listaDeLugares = new ArrayList<>();
        pontoArtesanatosRepositorio = new PontoArtesanatosRepositorio(this);
        ...
        lista.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                Intent intent = new Intent(ArtesanatosActivity.this, PontoEscolhidoActivity.class);
