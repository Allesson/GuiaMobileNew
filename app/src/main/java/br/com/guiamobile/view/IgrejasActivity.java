...
import br.com.guiamobile.controller.PontoIgrejasRepositorio;
...
public class IgrejasActivity extends AppCompatActivity {
    ...
    private PontoIgrejasRepositorio pontoIgrejasRepositorio;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lista.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                Intent intent = new Intent(IgrejasActivity.this, PontoEscolhidoActivity.class);
    ...
    private void carregarLugares() {
        listaDeLugares = pontoIgrejasRepositorio.listar();
