...
import br.com.guiamobile.controller.PontoBaresRestRepositorio;
 ...
 */
public class BaresRestActivity extends AppCompatActivity {
    private static final int BUSCAR = 1;
    private ListView lista;
    private PontoBaresRestRepositorio pontoBaresRestRepositorio;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pontoBaresRestRepositorio = new PontoBaresRestRepositorio(this);
        ...
        lista.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                Intent intent = new Intent(BaresRestActivity.this, PontoEscolhidoActivity.class);
    ...
    private void carregarLugares() {
        listaDeLugares = pontoBaresRestRepositorio.listar();
