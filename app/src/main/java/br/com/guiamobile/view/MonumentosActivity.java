...
import br.com.guiamobile.controller.PontoMonumentosRepositorio;
...
public class MonumentosActivity extends AppCompatActivity {
    ...
    private PontoMonumentosRepositorio pontoMonumentosRepositorio;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.Monumentos);
        listaDeLugares = new ArrayList<>();
        pontoMonumentosRepositorio = new PontoMonumentosRepositorio(this);
        ...
        lista.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                Intent intent = new Intent(MonumentosActivity.this, PontoEscolhidoActivity.class);
    ...
    private void carregarLugares() {
        listaDeLugares = pontoMonumentosRepositorio.listar();
