...
import br.com.guiamobile.controller.PontoPontesRepositorio;
import br.com.guiamobile.model.Adapter.RetornoBusca_Adapter;
import br.com.guiamobile.model.PontoTuristico;

/**
 * Created by Gilberto on 28/05/2016.
 */
public class PontesActivity extends AppCompatActivity {

    private static final int BUSCAR = 1;
    private ListView lista;
    private PontoPontesRepositorio pontoPontesRepositorio;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lista.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                Intent intent = new Intent(PontesActivity.this, PontoEscolhidoActivity.class);
    ...
    private void carregarLugares() {
        listaDeLugares = pontoPontesRepositorio.listar();
