...
import br.com.guiamobile.controller.PontoParquesPracasRepositorio;
 ...
 */
public class ParquesPracasActivity extends AppCompatActivity {
    private static final int BUSCAR = 1;
    private ListView lista;
    private PontoParquesPracasRepositorio pontoParquesPracasRepositorio;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pontoParquesPracasRepositorio = new PontoParquesPracasRepositorio(this);
        ...
        lista.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                Intent intent = new Intent(ParquesPracasActivity.this, PontoEscolhidoActivity.class);
    ...
    private void carregarLugares() {
        listaDeLugares = pontoParquesPracasRepositorio.listar();
