 ...
 */
public class PontoMuseusTRepositorio {

    private PontoTuristicoOpenHelper pontoTuristicoOpenHelper;

    public PontoMuseusTRepositorio(Context context) {
    ...
    public List<PontoTuristico> buscarPontoMuseusT(String busca) {
        ...
        String selectSQL = "SELECT * FROM tbl_pontoMuseusT WHERE titulo LIKE '%" + busca + "%'";
